...
@include('partials.header')
   ...
   <main class="bg-white max-w-lg mx-auto p-8 my-10 rounded-lg shadow-2x1 ">
        ...
        <section>
            <h1 class="font-bold text-2x-1">Welcome to Registration Form</h1>
            <p class="text-gray-600 pt-2">Sign up </p>
        </section>
        <section class="mt-10">
                <form action="" class="flex flex-col">
                        <div class=".mb-6.pt-3.rounded bg-gray-200">
                            <label for="Name" class="block text-gray-700 text-sm font-bold mb-2 ml-3 mt-2">Name</label>
                            <input type="text" class="bg-gray-200 rounded w-full text-gray-700 focus:outline-none border-b-4 border-gray-400 px-3 ">
                         </div>
                         <div class=".mb-6.pt-3.rounded bg-gray-200">
                            <label for="Email" class="block text-gray-700 text-sm font-bold mb-2 ml-3 mt-2 ">Email</label>
                         ...
                         <button class="bg-purple-600 hover-bg-purple-700 mt-2 text-white font-bold py-2 rounded shadow-lg hover:shadow-x1 transition duration-200" type="submit">Sign in</button>  
                </form>
        </section>
   </main>
